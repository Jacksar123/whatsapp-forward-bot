...
const BATCH_SIZE = 3;                 // fewer groups per batch to reduce churn
const PARALLEL_PER_SLICE = 2;         // small per-batch concurrency
const PER_SEND_DELAY_MS = 250;        // small delay between sends
const BATCH_DELAY_MS = 5000;          // wait between batches
const SEND_MAX_RETRIES = 3;           // retry a few times per group
